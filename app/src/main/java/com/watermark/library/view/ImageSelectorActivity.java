package com.watermark.library.view;
...
import com.watermark.library.R;
import com.watermark.library.adapter.ImageFolderAdapter;
import com.watermark.library.adapter.ImageListAdapter;
import com.watermark.library.model.LocalMedia;
import com.watermark.library.model.LocalMediaFolder;
import com.watermark.library.utils.GridSpacingItemDecoration;
import com.watermark.library.utils.LocalMediaLoader;
import com.watermark.library.utils.ScreenUtils;
import com.watermark.library.view.base.BaseActivity;
import com.watermark.library.view.base.PermissionHandler;
    ...
    protected void onEventComming(EventCenter eventCenter) {
        ...
        switch (eventCode) {
            ...
            case WatermarkCameraActivity.REQUEST_WATERMARK_CAMERA:
                cameraPath = eventCenter.getData().toString();
                images.add(0, new LocalMedia(cameraPath));
    ...
    protected void initViewsAndEvents() {
        ...
        new LocalMediaLoader(this, LocalMediaLoader.TYPE_IMAGE).loadAllImage(new LocalMediaLoader.LocalMediaLoadListener() {
            ...
            public void loadComplete(List<LocalMediaFolder> folders) {
                ...
                images = folders.get(0).getImages();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == REQUEST_CAMERA) {
                saveImageToGallery(this, cameraPath);
//                sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(new File(cameraPath))));
        ...
        requestCameraPermission(new PermissionHandler() {
            ...
            public void onGranted() {
                ...
                if (state.equals(Environment.MEDIA_MOUNTED)) {
                    startActivity(new Intent(ImageSelectorActivity.this, WatermarkCameraActivity.class));
                } else {
                    Toast.makeText(ImageSelectorActivity.this, getString(R.string.sdcard_of_no_avail), Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onDenied() {
                Toast.makeText(ImageSelectorActivity.this, getString(R.string.denied_camera_permission), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onSelectDone(String path) {
        images.add(0, new LocalMedia(path));
        imageAdapter.bindImages(images);
        imageAdapter.notifyDataSetChanged();
//        ArrayList<String> images = new ArrayList<>();
//        images.add(path);
